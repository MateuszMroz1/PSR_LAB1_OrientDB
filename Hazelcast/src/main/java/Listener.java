...
public class Listener {
    public static void StartListener() throws UnknownHostException {
        ...
        IMap<Long, Liga> students = instance.getMap("Liga");

        students.addEntryListener(new EntryAddedListener<Long, Liga>() {

            @Override
            public void entryAdded(EntryEvent<Long, Liga> e) {
                System.out.println(e);
            }
        }, true);
